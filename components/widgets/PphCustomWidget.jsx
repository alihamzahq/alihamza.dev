...
/**
 * Custom PPH Widget (Backup)
 *
 * This is a custom-built PPH widget matching the Upwork widget style.
 * Use this as a fallback if the official PPH iframe widget has issues.
 *
 * To switch: In FreelanceWidgets.jsx, replace:
 *   import PphWidget from './PphWidget';
 * with:
 *   import PphWidget from './PphCustomWidget';
 */
...
export default function PphCustomWidget() {
  return (
    <div
