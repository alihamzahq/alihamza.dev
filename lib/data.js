...
export const projects = [
  {
    ...
    description:
      'Large-scale enterprise multi-tenant SaaS platform for content management and publishing workflows. Features domain-based tenant resolution, strict data isolation, role-based access control, and subscription billing. Designed to support thousands of tenants.',
    ...
    problem: 'Powers scalable content management for multiple organizations with strict tenant isolation',
  },
  {
    title: 'Sports Seat Swapping Marketplace',
    description:
      'Production-grade Laravel backend powering a sports seat swapping marketplace with 80+ REST API endpoints, real-time chat, Stripe subscriptions, Firebase push notifications, and a full Admin CMS. Serves iOS and Android clients.',
    stack: ['Laravel', 'MySQL', 'Redis', 'Stripe', 'Firebase', 'REST APIs'],
    github: 'https://github.com/alihamzahq/sports-seat-swap-platform',
    demo: null,
    problem: 'Enables fans to discover and exchange stadium seats with real-time communication and subscription access',
  },
  {
